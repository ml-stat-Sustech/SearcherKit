...
from searcherkit.common.log import configure_run_logging, get_logger, log_context
from searcherkit.common.dataloader import DataConfig, DataItem, GenericDataLoader
from searcherkit.common.errors import SearcherKitError
from searcherkit.runtime import startup
from searcherkit.common.retry import retry_async, RetryConfig, RetryPolicy
from searcherkit.runtime.batch import BatchItem, BatchSummary
from searcherkit.runtime.checkpoint import CheckpointConfig, CheckpointError, CheckpointStore
from searcherkit.runtime.trace import (
        ...
        with log_context(scope="global", run_id=run_id):
            ...
            async def _run_one(
                ...
                with log_context(
                    ...
                    except (SearcherKitError, OSError, TimeoutError, ValueError, RuntimeError) as exc:
                        ended_at = datetime.now().isoformat(timespec="milliseconds")
                        elapsed = round(time.monotonic() - started_monotonic, 3)
                        if checkpoint_store is not None:
                            try:
