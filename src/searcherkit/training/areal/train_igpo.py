...
def _print_fallback_help(missing_name: str) -> None:
    ...
    print(
        "usage: python -m searcherkit.training.areal.train_igpo --config CONFIG "
        "[overrides ...]\n\n"
        "SearcherKit AReaL-IGPO training entry. Full AReaL dependencies are "
...
def _load_dependencies(argv: list[str]):
    try:
        ...
        from searcherkit.training.areal.igpo import IGPOTrainer
...
def main(args: list[str] | None = None) -> None:
    ...
    with IGPOTrainer(
        ...
        trainer.train(
            workflow="searcherkit.training.areal.workflow_igpo.ARealIGPOSearchAgentWorkflow",
            eval_workflow="searcherkit.training.areal.workflow_igpo.ARealIGPOSearchAgentWorkflow",
