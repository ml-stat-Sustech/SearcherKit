"""Config-driven ms-swift training launcher for SearcherKit agentic SFT."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train SearcherKit agentic SFT data with ms-swift.")
