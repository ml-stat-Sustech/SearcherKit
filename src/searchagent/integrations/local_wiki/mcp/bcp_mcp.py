...
from searchagent.integrations.local_wiki.retrievers.retrievers import build_retriever
from searchagent.integrations.local_wiki.retrievers.encoders import build_encoder, load_model
...
class VLLMEncoder:
    ...
    async def encode(self, texts: str) -> np.ndarray:
