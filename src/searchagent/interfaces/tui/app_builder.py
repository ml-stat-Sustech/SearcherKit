...
from searchagent.interfaces.tui.slash.slash_menu import SlashMenu
from searchagent.interfaces.tui.ui.input_field import InputField
from searchagent.interfaces.tui.ui.selection_manager import SelectionManager
...
class TuiApplicationBuilder:
    ...
    def build(self) -> Any:
        try:
            ...
            raise ImportError(
                "searchagent tui requires prompt-toolkit. Install it with "
    ...
    def _tui_style(self) -> Any:
        from searchagent.interfaces.tui.ui.formatting import _tui_style
        return _tui_style()
