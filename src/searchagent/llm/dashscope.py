"""DashScope OpenAI-compatible client adapter."""

from __future__ import annotations

from typing import Any

from searchagent.llm.base import ClientConfig, DashScopeConfig
...
class DashScopeClient(OpenAIClient):
    def __init__(self, *, config: ClientConfig | None = None, **kwargs: Any) -> None:
        if config is not None:
            provider_config = config.dashscope or DashScopeConfig()
