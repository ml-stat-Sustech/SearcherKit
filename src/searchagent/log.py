...
_CONSOLE_HANDLER_NAME = "searchagent.console"
_RUN_FILE_HANDLER_NAME = "searchagent.run_file"
_TRACE_ROUTER_HANDLER_NAME = "searchagent.trace_router"
...
_scope_var: ContextVar[str] = ContextVar("searchagent_log_scope", default="global")
_run_id_var: ContextVar[str] = ContextVar("searchagent_run_id", default="-")
_sample_id_var: ContextVar[str] = ContextVar("searchagent_sample_id", default="-")
_trace_id_var: ContextVar[str] = ContextVar("searchagent_trace_id", default="-")
_turn_var: ContextVar[str] = ContextVar("searchagent_turn", default="-")
