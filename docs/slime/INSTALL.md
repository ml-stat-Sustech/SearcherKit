...
`train/slime/train_dist_slime.sh` also prepares these paths for the training process, but Ray itself should be started from a shell that already has them.
